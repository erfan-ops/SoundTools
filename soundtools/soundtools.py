...
class Sounds:
    ...
    def organ(self, freq:float, dur:float, vol: float) -> SoundBuffer:
        ...
        wave: SoundBuffer = (buf/(7*2.424)).astype(self.dtype)
        # wave = (buf/7*2.4247).astype(self.dtype) # for better percision (might cause quality issues with high amplitudes)
        return wave
